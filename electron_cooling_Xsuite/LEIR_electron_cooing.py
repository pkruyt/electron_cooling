...
arc=dtk.LinearTransferMatrix(Q_x=1.8205, Q_y=2.72,
...
xi=np.array(x)
pxi=np.array(px)
colorbar=list(range(num_turns))
result = [number/1000 for number in colorbar]
plt.figure()


plt.scatter(xi[0:-1:201],pxi[0:-1:201] , c=colorbar[0:-1:201], cmap='jet')
